...
mech_dir = '/home/moon/autoscience/reaction_calculator/models/base_rmg24'
mech_dir = '/work/westgroup/harris.se/autoscience/reaction_calculator/models/base_rmg_1week'
mech_dir = '/home/moon/autoscience/reaction_calculator/models/base_rmg_1week'
...
np.save(os.path.join(mech_dir, 'reaction_uncertainty.npy'), uncorrelated_uncertainties)
np.save(os.path.join(mech_dir, 'species_uncertainty.npy'), uncertainty.thermo_input_uncertainties)
